"""
=============================================================================
MODULE 6 – FEATURE ENGINEERING  |  normaliser.py
=============================================================================
...
from config import (
    SCALER_TYPE, DEMOGRAPHIC_ENCODINGS, META_COLS,
)
...
class FeatureNormaliser:
    ...
    def save(self, path: str | Path):
        """Persist fitted scalers to disk using joblib (R6.1 compliant)."""
        joblib.dump({"scalers": self._scalers,
                     "feature_cols": self._feature_cols,
                     "scaler_type": self.scaler_type}, path)

    @classmethod
    def load(cls, path: str | Path) -> "FeatureNormaliser":
        """Load fitted scalers from a trusted path using joblib."""
