"""
=============================================================================
MODULE 5 – DATA ANALYSER  |  main.py
=============================================================================
Interactive CLI entry point for Module 5.
...
def _browse_source() -> Path:
    ...
    candidates, labels = [], []
    for root, tag in [
        (REPO_ROOT / "module_5_preprocessing" / "outputs", "M5"),
...
def _interactive():
    ...
    print("  ║        Module 5 — Data Analyser" + " " * (WIDTH - 36) + "║")
...
def _cli():
    p = argparse.ArgumentParser(description=f"Module 5 Data Analyser v{MODULE_VERSION}")
